...
<section class="paper-detail" id="paper-detail">
  ...
  <header class="paper-detail__hero">
    ...
    <div class="paper-detail__links"><a class="paper-detail__doi" href="https://doi.org/10.48550/arXiv.2506.05295" target="_blank" rel="noopener noreferrer" aria-label="Open DOI for Sample_Complexity_Representation_Test_Time_Scaling">Open paper <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a><a class="paper-detail__code" href="https://github.com/LithiumDA/Representation-Ability-of-Test-time-Scaling" target="_blank" rel="noopener noreferrer" aria-label="Open code for Sample_Complexity_Representation_Test_Time_Scaling">Code <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a></div>
  </header>
