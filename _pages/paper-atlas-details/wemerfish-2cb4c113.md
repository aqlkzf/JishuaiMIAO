...
<section class="paper-detail" id="paper-detail">
  ...
  <header class="paper-detail__hero">
    ...
    <div class="paper-detail__links"><a class="paper-detail__doi" href="https://doi.org/10.1126/science.adt3439" target="_blank" rel="noopener noreferrer" aria-label="Open DOI for weMERFISH">Open paper <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a><a class="paper-detail__code" href="https://github.com/yinan-wan0/weMERFISH" target="_blank" rel="noopener noreferrer" aria-label="Open code for weMERFISH">Code <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a></div>
  </header>
...
浏览器仓库是数据展示层，不能作为主实验与分析算法的 `code source`。
