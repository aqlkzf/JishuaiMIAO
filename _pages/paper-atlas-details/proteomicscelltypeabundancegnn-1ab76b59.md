...
<section class="paper-detail" id="paper-detail">
  ...
  <header class="paper-detail__hero">
    ...
    <div class="paper-detail__links"><a class="paper-detail__doi" href="https://doi.org/10.1002/advs.202502987" target="_blank" rel="noopener noreferrer" aria-label="Open DOI for ProteomicsCellTypeAbundanceGNN">Open paper <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a><a class="paper-detail__code" href="https://github.com/TencentAILabHealthcare/scpDeconv" target="_blank" rel="noopener noreferrer" aria-label="Open code for ProteomicsCellTypeAbundanceGNN">Code <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a></div>
  </header>
