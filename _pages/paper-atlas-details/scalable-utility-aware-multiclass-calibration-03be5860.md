...
<section class="paper-detail" id="paper-detail">
  ...
  <header class="paper-detail__hero">
    ...
    <div class="paper-detail__links"><a class="paper-detail__doi" href="https://doi.org/10.48550/arXiv.2510.25458" target="_blank" rel="noopener noreferrer" aria-label="Open DOI for Scalable_Utility_Aware_Multiclass_Calibration">Open paper <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a><a class="paper-detail__code" href="https://github.com/mahegz/Scalable-Calibration" target="_blank" rel="noopener noreferrer" aria-label="Open code for Scalable_Utility_Aware_Multiclass_Calibration">Code <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a></div>
  </header>
