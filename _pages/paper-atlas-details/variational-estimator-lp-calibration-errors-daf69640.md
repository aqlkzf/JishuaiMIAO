...
<section class="paper-detail" id="paper-detail">
  ...
  <header class="paper-detail__hero">
    ...
    <div class="paper-detail__links"><a class="paper-detail__doi" href="https://doi.org/10.48550/arXiv.2602.24230" target="_blank" rel="noopener noreferrer" aria-label="Open DOI for Variational_Estimator_Lp_Calibration_Errors">Open paper <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a><a class="paper-detail__code" href="https://github.com/dholzmueller/probmetrics" target="_blank" rel="noopener noreferrer" aria-label="Open code for Variational_Estimator_Lp_Calibration_Errors">Code <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a></div>
  </header>
