...
<section class="paper-detail" id="paper-detail">
  ...
  <header class="paper-detail__hero">
    ...
    <div class="paper-detail__links"><a class="paper-detail__doi" href="https://doi.org/10.48550/arXiv.2605.04266" target="_blank" rel="noopener noreferrer" aria-label="Open DOI for Explaining_Preventing_Alignment_Collapse_Iterative_RLHF">Open paper <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a><a class="paper-detail__code" href="https://github.com/GauthierE/fpo" target="_blank" rel="noopener noreferrer" aria-label="Open code for Explaining_Preventing_Alignment_Collapse_Iterative_RLHF">Code <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a></div>
  </header>
