...
<section class="paper-detail" id="paper-detail">
  ...
  <header class="paper-detail__hero">
    ...
    <div class="paper-detail__links"><a class="paper-detail__code" href="https://github.com/Air-8/SPA_CLUB" target="_blank" rel="noopener noreferrer" aria-label="Open code for RL_Multi_Phase_Second_Price_Auction_Design">Code <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a></div>
  </header>
