...
<section class="paper-detail" id="paper-detail">
  ...
  <header class="paper-detail__hero">
    ...
    <div class="paper-detail__links"><a class="paper-detail__doi" href="https://doi.org/10.1038/s41587-024-02475-x" target="_blank" rel="noopener noreferrer" aria-label="Open DOI for MultiPerturb-seq">Open paper <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a><a class="paper-detail__code" href="https://gitlab.com/sanjanalab/mps" target="_blank" rel="noopener noreferrer" aria-label="Open code for MultiPerturb-seq">Code <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a></div>
  </header>
