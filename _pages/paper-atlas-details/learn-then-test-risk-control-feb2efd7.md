...
<section class="paper-detail" id="paper-detail">
  ...
  <header class="paper-detail__hero">
    ...
    <div class="paper-detail__links"><a class="paper-detail__doi" href="https://doi.org/10.1214/24-AOAS1998" target="_blank" rel="noopener noreferrer" aria-label="Open DOI for Learn_Then_Test_Risk_Control">Open paper <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a><a class="paper-detail__code" href="https://github.com/aangelopoulos/ltt" target="_blank" rel="noopener noreferrer" aria-label="Open code for Learn_Then_Test_Risk_Control">Code <i class="fa-solid fa-arrow-up-right-from-square" aria-hidden="true"></i></a></div>
  </header>
